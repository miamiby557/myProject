...
public class CarSendFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.car_send, container, false);
        ...
        number = (EditText)rootView.findViewById(R.id.order_number);
        ...
        carSend = (Button)rootView.findViewById(R.id.car_send);
